...
from dao import DaoCategory, DaoSell, DaoStock, DaoSupplier
from database_files import category_txt, stock_txt, supplier_txt
from model import Category, Product, Sell, Stock, Supplier
